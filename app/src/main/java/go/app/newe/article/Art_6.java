...
public class Art_6 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        int additionint1 = addition1.nextInt(111)+4;
        ...
        Okay.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(Art_6.this, "Your message is delivered", Toast.LENGTH_SHORT).show();
                dialog.dismiss();
            }
        });
        ...
        Cancel.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(Art_6.this, "Cancel", Toast.LENGTH_SHORT).show();
                dialog.dismiss();
            }
        });
    ...
    private void setupView() {
        for (Screen screen : App.getAppConfig().getScreens()) {
            if (screen.getName().equals("article_6_screen")) {
                mScreen = screen;
                break;
            }
        }
            ...
            if (mScreen != null) {
                for (Advertisement advertisement : mScreen.getAdvertisements()) {
                    if (advertisement.getProvider().equals("admob")
                        ...
                        AdLoader adLoader = new AdLoader.Builder(Art_6.this, advertisement.getAdId())
                                .forNativeAd(nativeAd -> {
                                    NativeTemplateStyle styles = new NativeTemplateStyle
                                            .Builder()
                                            .build();
                                    LayoutInflater layoutInflater = (LayoutInflater) Art_6.this.getSystemService(LAYOUT_INFLATER_SERVICE);
    ...
    public void back(View view) {
        Intent intent = new Intent(Art_6.this, Data_Buttons.class);
