...
public class Art_4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        int additionint1 = addition1.nextInt(455)+7;
        ...
        Okay.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(Art_4.this, "Your message is delivered", Toast.LENGTH_SHORT).show();
                dialog.dismiss();
            }
        });
        ...
        Cancel.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(Art_4.this, "Cancel", Toast.LENGTH_SHORT).show();
                dialog.dismiss();
            }
        });
    ...
    private void setupView() {
        for (Screen screen : App.getAppConfig().getScreens()) {
            if (screen.getName().equals("article_4_screen")) {
                mScreen = screen;
                break;
            }
        }
            ...
            if (mScreen != null) {
                for (Advertisement advertisement : mScreen.getAdvertisements()) {
                    if (advertisement.getProvider().equals("admob")
                        ...
                        AdLoader adLoader = new AdLoader.Builder(Art_4.this, advertisement.getAdId())
                                .forNativeAd(nativeAd -> {
                                    NativeTemplateStyle styles = new NativeTemplateStyle
                                            .Builder()
                                            .build();
                                    LayoutInflater layoutInflater = (LayoutInflater) Art_4.this.getSystemService(LAYOUT_INFLATER_SERVICE);
