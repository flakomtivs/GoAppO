...
public class Activity_1 extends AppCompatActivity {
    ...
    private void setupAds() {
        for (Screen screen : App.getAppConfig().getScreens()) {
            if (screen.getName().equals("step_1_screen")) {
                mScreen = screen;
                break;
            }
        }
            ...
            if (mScreen != null) {
                for (Advertisement advertisement : mScreen.getAdvertisements()) {
                    if (advertisement.getProvider().equals("admob")
                        ...
                        AdLoader adLoader = new AdLoader.Builder(Activity_1.this, advertisement.getAdId())
                                .forNativeAd(nativeAd -> {
                                    NativeTemplateStyle styles = new NativeTemplateStyle
                                            .Builder()
                                            .build();
                                    LayoutInflater layoutInflater = (LayoutInflater) Activity_1.this.getSystemService(LAYOUT_INFLATER_SERVICE);
                    ...
                    if (advertisement.getProvider().equals("admob")
                        ...
                        InterstitialAd.load(Activity_1.this, advertisement.getAdId(), adRequest,
