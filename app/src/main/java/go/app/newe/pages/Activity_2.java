...
public class Activity_2 extends AppCompatActivity {
    ...
    private void setupAds() {
        for (Screen screen : App.getAppConfig().getScreens()) {
            if (screen.getName().equals("step_2_screen")) {
                mScreen = screen;
                break;
            }
        }
            ...
            if (mScreen != null) {
                for (Advertisement advertisement : mScreen.getAdvertisements()) {
                    if (advertisement.getProvider().equals("admob")
                        ...
                        AdLoader adLoader = new AdLoader.Builder(Activity_2.this, advertisement.getAdId())
                                .forNativeAd(nativeAd -> {
                                    NativeTemplateStyle styles = new NativeTemplateStyle
                                            .Builder()
                                            .build();
                                    LayoutInflater layoutInflater = (LayoutInflater) Activity_2.this.getSystemService(LAYOUT_INFLATER_SERVICE);
                    ...
                    if (advertisement.getProvider().equals("admob")
                        ...
                        InterstitialAd.load(Activity_2.this, advertisement.getAdId(), adRequest,
