            ...
            if (mScreen != null) {
                for (Advertisement advertisement : mScreen.getAdvertisements()) {
                    if (advertisement.getProvider().equals("admob")
                        ...
                        AdLoader adLoader = new AdLoader.Builder(Activity_4.this, advertisement.getAdId())
                                .forNativeAd(nativeAd -> {
                                    NativeTemplateStyle styles = new NativeTemplateStyle
                                            .Builder()
                                            .build();
                                    LayoutInflater layoutInflater = (LayoutInflater) Activity_4.this.getSystemService(LAYOUT_INFLATER_SERVICE);
                    ...
                    if (advertisement.getProvider().equals("admob")
                        ...
                        InterstitialAd.load(Activity_4.this, advertisement.getAdId(), adRequest,
